...
class TransAm(nn.Module):
    def __init__(self, feature_size=128, num_layers=2, dropout=0.15):
...
#           target_data, __ = target_iter.next()
        ...
        lambd = 2 / (1 + math.exp(-2* (epoch) / epochs)) - 1
...
def main():
    ...
    for epoch in range(1, epochs + 1):
        ...
        wb = load_workbook(r"data_01/acc-loss-12-08.xlsx")  # 表存在，导入
        ws = wb['Sheet1']
        ...
        wb.save(r"data_01/acc-loss-12-08.xlsx")
    ...
    plot_pca(t_fusion1_cpu, targets_cpu, n_components=2, title='t_fusion1 PCA (2D)',
             save_path_image=f'pca_12_08/t_fusion1_pca_2d_epoch_{epoch}.png',
             save_path_excel=f'pca_12_08/t_fusion1_pca_2d_epoch_{epoch}.xlsx')
    plot_pca(t_fusion2_cpu, targets_cpu, n_components=2, title='t_fusion2 PCA (2D)',
             save_path_image=f'pca_12_08/t_fusion2_pca_2d_epoch_{epoch}.png',
             save_path_excel=f'pca_12_08/t_fusion2_pca_2d_epoch_{epoch}.xlsx')
    plot_pca(s_fusion1_cpu, labels_fusion1_cpu, n_components=2, title='s_fusion1 PCA (2D)',
             save_path_image=f'pca_12_08/s_fusion1_pca_2d_epoch_{epoch}.png',
             save_path_excel=f'pca_12_08/s_fusion1_pca_2d_epoch_{epoch}.xlsx')
    plot_pca(s_fusion2_cpu, labels_fusion2_cpu, n_components=2, title='s_fusion2 PCA (2D)',
             save_path_image=f'pca_12_08/s_fusion2_pca_2d_epoch_{epoch}.png',
             save_path_excel=f'pca_12_08/s_fusion2_pca_2d_epoch_{epoch}.xlsx')
    ...
    plot_tsne(t_fusion1_cpu, targets_cpu, n_components=2, title='t_fusion1 t-SNE (2D)',
              save_path_image=f'pca_12_08/t_fusion1_tsne_2d_epoch_{epoch}.png',
              save_path_excel=f'pca_12_08/t_fusion1_tsne_2d_epoch_{epoch}.xlsx')
    plot_tsne(t_fusion2_cpu, targets_cpu, n_components=2, title='t_fusion2 t-SNE (2D)',
              save_path_image=f'pca_12_08/t_fusion2_tsne_2d_epoch_{epoch}.png',
              save_path_excel=f'pca_12_08/t_fusion2_tsne_2d_epoch_{epoch}.xlsx')
    plot_tsne(s_fusion1_cpu, labels_fusion1_cpu, n_components=2, title='s_fusion1 t-SNE (2D)',
              save_path_image=f'pca_12_08/s_fusion1_tsne_2d_epoch_{epoch}.png',
              save_path_excel=f'pca_12_08/s_fusion1_tsne_2d_epoch_{epoch}.xlsx')
    plot_tsne(s_fusion2_cpu, labels_fusion2_cpu, n_components=2, title='s_fusion2 t-SNE (2D)',
              save_path_image=f'pca_12_08/s_fusion2_tsne_2d_epoch_{epoch}.png',
              save_path_excel=f'pca_12_08/s_fusion2_tsne_2d_epoch_{epoch}.xlsx')
